function dic_dt = di_converters_dt(v_convertersonly, ic, vdc, m, Zac_converters, inv_Lac_converters)
%{
...
vsw = zeros(nconverters*2,1);
for i = 1:nconverters
    vsw(2*i-1:2*i) = vdc(i)*m(2*i-1:2*i)/2; 
end

dic_dt = inv_Lac_converters*(-Zac_converters*ic + v_convertersonly - vsw);
