...
%get parameters
    ...
    rv = params.rv; %Virtual resistance
    lv = params.lv;% Virtual inductance
    q_ref = params.q_ref;
    v_ref = params.v_ref;
...
f = [
      ...
      wb*cf*kpc*vod*delta_w_vsm/lf; % Sign changed to match paper (- to +)
