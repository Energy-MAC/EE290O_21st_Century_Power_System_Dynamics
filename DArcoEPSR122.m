...
x00_IB = fsolve(@(x)DAIMIB(0,x,inverter_params, line_params, infbus_params),[x0(1:19),V_R,V_I],options_dae);
x00 = fsolve(@(x)DAIM_paper(0,x,inverter_params),x0(1:19),options_dae);
...
[t4_1,y4_1] = ode23t(@(t,x)DAIM_paper(t,x,inverter_params), [0:0.01:10], x00', opts);
...
[t4_2,y4_2] = ode23t(@(t,x)DAIM_paper(t,x,inverter_params), [0:0.01:10], x00', opts);
