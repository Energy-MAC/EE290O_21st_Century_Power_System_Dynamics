...
x00 = fsolve(@(x)AVRSM_IF(0,x, gen_params, AVR_params, line_params, infbus_params),[1.0, 0.0, 0.0], options_dae);

%M = eye(19);
opts = odeset('RelTol',1e-8,'AbsTol',1e-8);
[t,y] = ode23t(@(t,x)AVRSM_IF(t,x, gen_params, AVR_params, line_params, infbus_params), [0:0.01:4], x00', opts);
