...
x00 = fsolve(@(x)DAIIB_dc_side(0,x,inverter_params,battery_params),x0,options_dae);
M = eye(24);
M(24,24)=0;
...
[t4_1,y4_1] = ode23t(@(t,x)DAIIB_dc_side(t,x,inverter_params,battery_params), [0:0.01:5], x00', opts);
