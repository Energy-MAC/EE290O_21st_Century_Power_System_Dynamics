function digdt = di_gens_dt(i_gens, v_buses, theta_gens, omega_gens,  i_f_gens, inv_L_gens, Z_gens, I_inc_gens, Ell_gens)
...
digdt = inv_L_gens*(-Z_gens * i_gens + I_inc_gens'*v_buses - v_ind_gens);
end